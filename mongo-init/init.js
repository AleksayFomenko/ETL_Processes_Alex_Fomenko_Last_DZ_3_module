...
/* ------------------ UserSessions ------------------ */
db.UserSessions.insertOne({ session_id: "sess_001", user_id: "user_001", start_time: new Date("2024-01-10T09:00:00Z"), end_time: new Date("2024-01-10T09:30:00Z"), pages_visited: ["/home","/products","/products/1","/cart"], device: {type:"mobile"}, actions:["login","view_product","add_to_cart","logout"] });
db.UserSessions.insertOne({ session_id: "sess_002", user_id: "user_002", start_time: new Date("2024-01-10T10:10:00Z"), end_time: new Date("2024-01-10T10:50:00Z"), pages_visited: ["/home","/search","/products/2"], device: {type:"desktop"}, actions:["login","search","view_product","logout"] });
db.UserSessions.insertOne({ session_id: "sess_003", user_id: "user_003", start_time: new Date("2024-01-10T11:05:00Z"), end_time: new Date("2024-01-10T11:35:00Z"), pages_visited: ["/home","/products/3","/cart"], device: {type:"tablet"}, actions:["login","view_product","add_to_cart","logout"] });
db.UserSessions.insertOne({ session_id: "sess_004", user_id: "user_004", start_time: new Date("2024-01-10T12:15:00Z"), end_time: new Date("2024-01-10T12:45:00Z"), pages_visited: ["/home","/products","/products/4","/checkout"], device: {type:"desktop"}, actions:["login","view_product","checkout","logout"] });
db.UserSessions.insertOne({ session_id: "sess_005", user_id: "user_005", start_time: new Date("2024-01-10T13:00:00Z"), end_time: new Date("2024-01-10T13:20:00Z"), pages_visited: ["/home","/products/5"], device: {type:"mobile"}, actions:["login","view_product","logout"] });
db.UserSessions.insertOne({ session_id: "sess_006", user_id: "user_006", start_time: new Date("2024-01-10T14:30:00Z"), end_time: new Date("2024-01-10T15:00:00Z"), pages_visited: ["/home","/blog","/products/6"], device: {type:"desktop"}, actions:["login","read_blog","view_product","logout"] });
db.UserSessions.insertOne({ session_id: "sess_007", user_id: "user_007", start_time: new Date("2024-01-10T15:10:00Z"), end_time: new Date("2024-01-10T15:40:00Z"), pages_visited: ["/home","/products/7","/cart"], device: {type:"mobile"}, actions:["login","view_product","add_to_cart","logout"] });
db.UserSessions.insertOne({ session_id: "sess_008", user_id: "user_008", start_time: new Date("2024-01-10T16:00:00Z"), end_time: new Date("2024-01-10T16:50:00Z"), pages_visited: ["/home","/products/8","/checkout"], device: {type:"tablet"}, actions:["login","view_product","checkout","logout"] });
db.UserSessions.insertOne({ session_id: "sess_009", user_id: "user_009", start_time: new Date("2024-01-10T17:05:00Z"), end_time: new Date("2024-01-10T17:35:00Z"), pages_visited: ["/home","/products/9"], device: {type:"desktop"}, actions:["login","view_product","logout"] });
db.UserSessions.insertOne({ session_id: "sess_010", user_id: "user_010", start_time: new Date("2024-01-10T18:15:00Z"), end_time: new Date("2024-01-10T18:45:00Z"), pages_visited: ["/home","/products/10","/cart"], device: {type:"mobile"}, actions:["login","view_product","add_to_cart","logout"] });
